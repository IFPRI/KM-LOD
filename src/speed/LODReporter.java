...
public class LODReporter 
  {
  String report = null;	
  String baseOntology = "http://data.ifpri.org/lod/indicator/resource/";
  String resourceBase;
  String base;
  ...
  speed.ConnectorToOntology connector;
 ...
 */ 
  public LODReporter(speed.ConnectorToOntology connector2) 
    {
...
public String getOntologyOverview(Model selectedModel,String resourceName, String currentServerPath,String language)
  ...
  public void writeStatement(Model selectedModel, com.hp.hpl.jena.rdf.model.Statement statement)
    ...
    Property predicate = statement.getPredicate();
      ...
      String newPath = this.currentServerPath+"/lod/indicator/resource/";
  ...
  public void writeInstanceStatement( com.hp.hpl.jena.rdf.model.Statement statement,Resource selectedClass)
    ...
    if (predicate.getLocalName().equalsIgnoreCase(typeProperty.getLocalName())  && object.toString().equalsIgnoreCase(selectedClass.getURI()))
      ...
      if (subject.getURI().startsWith(this.currentServerPath))
        ...
        {
        report += "<span class='active-entity'> <span rel='owl:Individual' resource='"+this.currentServerPath+"/lod/indicator/resource/"+subject.getLocalName()+"'>"+"<a href=\""+this.currentServerPath+"/lod/indicator/resource/"+subject.getLocalName()+"\" title =\""+subject.getURI()+"\">"+subject.getLocalName()+"</a></span></span>";
        }  
      else
        report += "<span class='active-entity'> <span rel='owl:Individual' resource='"+subject.getURI()+"'>"+"<a href=\""+subject.getURI()+"\" title =\""+subject.getURI()+"\">"+subject.getLocalName()+"</a></span></span>";
    ...
    // show all istances separated by "|"
...
*/
  ...
  private void writeIFPRILogo(String selectedLanguage)
    ...
    if (selectedLanguage.equalsIgnoreCase("EN"))
      ...
      report +="    <td><p class=\"name\"><h1>Linked Open Data - The Statistics of Public Expenditure for Economic Development (SPEED)</h1></p>\n";
//      report +="         <p align =\"right\" class=\"description\"> <a href=\"http://data.ifpri.org/lod/arabspatial/fr\">French</a>, <a href=\"http://data.ifpri.org/lod/arabspatial/fr\">Spanish</p>";
      ...
      report +="                             <a href=\"http://www.ifpri.org/book-39/ourwork/programs/priorities-public-investment/speed-database\"><strong>Statistics of Public Expenditure for Economic Development (SPEED) database</strong></a> <br>&nbsp; </br>";

      report +="         <p class=\"description\">The Statistics of Public Expenditure for Economic Development (SPEED) database provides the most comprehensive and publicly available public expenditure information for 67 countries and six sectors: agriculture, education, health, defense, social protection, and transportation and communication.</p>";
      report +="        </p> \n";
      report +="   </td> \n";
      report +="</TR>\n";
      report +="</TABLE>\n";
      ...
      report +="                             <a href=\"http://www.ifpri.org/book-39/ourwork/programs/priorities-public-investment/speed-database\" target=\"_blank\"><strong>La Estadística de Gasto Público para el Desarrollo Económico (SPEED)  </strong></a> <br>&nbsp; </br>";
      ...
      report +="        <p class=\"newsdet\"><a href=\"http://data.ifpri.org/\" target=\"_blank\"><strong>IFPRI Data </strong></a>&gt;";
      report +="                             <a href=\"http://www.ifpri.org/book-39/ourwork/programs/priorities-public-investment/speed-database\"><strong>Les statistiques des dépenses publiques pour le développement économique (SPEED)  </strong></a> <br>&nbsp; </br>";

      report +="         <p class=\"description\">Les statistiques des dépenses publiques pour le développement économique (SPEED) Fournit la base de données la plus complète et informations publiquement disponibles pour les dépenses aux 67 clubs de pays publics et six des industries: l'agriculture, l'éducation, la santé, la défense, la protection sociale, les transports et la communication.</a>.</p>";
      report +="        </p> \n";
      report +="   </td> \n";
      report +="</TR>\n";
      report +="</TABLE>\n";
...
//      report +="         <p align =\"right\" class=\"description\"> <a href=\"http://data.ifpri.org/lod/arabspatial/fr\">French</a>, <a href=\"http://data.ifpri.org/lod/arabspatial/fr\">Spanish</p>";
  ...
  private void writeMenu(String selectedLanguge)
    ...
    if (selectedLanguge.equalsIgnoreCase("EN"))
      {
      report += " <h2><a href=\""+this.currentServerPath+"/lod/indicator/resource/"+"\">Overview</a> </h2>";
      ...
      report += "   <div>  \n";
       ...
       // Classes  
      findClassTree("http://data.ifpri.org/lod/indicator/resource/Indicator",0);
...
//      report +="     <li> <a href=\"http://www.ifpri.org/sites/default/files/ghi2012datam.xlsx\">EXCEL</a> </li>";
      report +="     <li> <a href=\"http://data.ifpri.org/lod/speed.owl\">OWL</a> </li>";
//      report +="     <li> <a href=\"http://data.ifpri.org/lod/arabspatial.rdf\">RDF</a> </li>";
      ...
      report += " <h2><a href=\""+this.currentServerPath+"/lod/indicator/resource/"+"\">visión de conjunto</a> </h2>";
 ...
 //     report +="     <li> <a href=\"http://data.ifpri.org/lod/arabspatial.owl\">OWL</a> </li>";
      ...
      report += " <h2><a href=\""+this.currentServerPath+"/lod/indicator/resource/"+"\">Vue d'ensemble</a> </h2>";
...
/*  
 *  SPEED : It takes too much time to write down all resources together, since there are too many.
