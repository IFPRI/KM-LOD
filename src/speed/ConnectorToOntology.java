...
public class ConnectorToOntology
  ...
  String fileName= "http://data.ifpri.org/lod/speed.owl";
  boolean isValidISO3Flag = false; // if parameter ISO3 is valid, it is true
  String ontologyBase = "http://data.ifpri.org/lod/indicator/resource/";
   
  String base= "http://data.ifpri.org/lod/indicator/resource/";
  String resourceBase= "http://data.ifpri.org/lod/indicator/resource/";
  String dataBase= "http://data.ifpri.org/lod/indicator/data/";
  String pageBase= "http://data.ifpri.org/lod/indicator/page/";
  String queryBase;
