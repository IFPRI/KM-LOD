...
public class LODReporter 
  {
  String report = null;	
  String baseOntology = "http://data.ifpri.org/lod/arabspatial/resource/";
  String resourceBase;
  String base;
  ...
  arabspatial.ConnectorToOntology connector;
 ...
 */ 
  public LODReporter(arabspatial.ConnectorToOntology connector2) 
    {
...
public String getOntologyOverview(Model selectedModel,String resourceName, String currentServerPath,String language)
  ...
  public void writeStatement(Model selectedModel, com.hp.hpl.jena.rdf.model.Statement statement)
    ...
    Property predicate = statement.getPredicate();
      ...
      String newPath = this.currentServerPath+"/lod/arabspatial/resource/";
  ...
  public void writeInstanceStatement( com.hp.hpl.jena.rdf.model.Statement statement,Resource selectedClass)
    ...
    if (predicate.getLocalName().equalsIgnoreCase(typeProperty.getLocalName())  && object.toString().equalsIgnoreCase(selectedClass.getURI()))
      ...
      if (subject.getURI().startsWith(this.currentServerPath))
        ...
        {
        report += "<span class='active-entity'> <span rel='owl:Individual' resource='"+this.currentServerPath+"/lod/arabspatial/resource/"+subject.getLocalName()+"'>"+"<a href=\""+this.currentServerPath+"/lod/arabspatial/resource/"+subject.getLocalName()+"\" title =\""+subject.getURI()+"\">"+subject.getLocalName()+"</a></span></span>";
        }  
      else
        report += "<span class='active-entity'> <span rel='owl:Individual' resource='"+subject.getURI()+"'>"+"<a href=\""+subject.getURI()+"\" title =\""+subject.getURI()+"\">"+subject.getLocalName()+"</a></span></span>";
...
*/
  ...
  private void writeIFPRILogo(String selectedLanguage)
    ...
    if (selectedLanguage.equalsIgnoreCase("EN"))
      ...
      report +="    <td><p class=\"name\"><h1>Linked Open Data - Arab Spatial</h1></p>\n";
//      report +="         <p align =\"right\" class=\"description\"> <a href=\"http://data.ifpri.org/lod/arabspatial/fr\">French</a>, <a href=\"http://data.ifpri.org/lod/arabspatial/fr\">Spanish</p>";
      ...
      report +="<TR> \n";
      report +="    <td><a href=\"http://data.ifpri.org\" target=\"_blank\"><img alt=\"IFPRI\" src=\"http://data.ifpri.org/IFPRILogo.jpg\" border=\"0\"></img></a></td>\n";
      report +="    <td><p class=\"name\"><h1>Linked Open Data - �ndice Global del Hambre </h1></p>\n";
      report +="         <p align =\"right\" class=\"description\"> <a href=\"http://data.ifpri.org/lod/arabspatial/en\">English</a>, <a href=\"http://data.ifpri.org/lod/arabspatial/fr\">French</p>";
      ...
      report +="         <p class=\"description\">El Global Hunger Index (GHI) los datos se publica tambi�n como Linked Open Data (LOD) y vinculados con la norma ISO 3166-1 (alfa 3) del c�digo. La versi�n Linked Open Data de GHI se implementa utilizando el Resource Description Framework (RDF). Utiliza los indicadores de <a href=\"http://data.ifpri.org/lod/arabspatial/resource/Child_Mortality\">Child Mortality</a>, <a href =\"http://data.ifpri.org/lod/arabspatial/resource/Undernourishment\">Undernourishment</a>,<a href=\"http://data.ifpri.org/lod/arabspatial/resource/Child_Underweight\"> Child Underweight</a> vinculado por pa�s y por a�o. Visite <a href=\"http://data.ifpri.org/sparql\">un punto final SPARQL para �ndice Global del Hambre</a> para consulta. </p>";
      report +="        </p> \n";
      report +="   </td> \n";
      report +="</TR>\n";
      report +="</TABLE>\n";
      ...
      report +="         <p align =\"right\" class=\"description\"> <a href=\"http://data.ifpri.org/lod/arabspatial/en\">English</a>, <a href=\"http://data.ifpri.org/lod/arabspatial/es\">Spanish</p>";
      report +="        <p class=\"newsdet\"><a href=\"http://data.ifpri.org/\" target=\"_blank\"><strong>IFPRI donn�es </strong></a>&gt;";
      ...
      report +="         <p class=\"description\">Le Global Hunger Index (GHI) de donn�es est �galement publi� en tant que Linked Open Data (LOD) et li� � la norme ISO 3166-1 (alpha 3) du code. Le Linked Open Data de la version IGS est impl�ment� en utilisant le Resource Description Framework (RDF). Il utilise les indicateurs de <a href=\"http://data.ifpri.org/lod/arabspatial/resource/Child_Mortality\">Child Mortality</a>, <a href =\"http://data.ifpri.org/lod/arabspatial/resource/Undernourishment\">Undernourishment</a>,<a href=\"http://data.ifpri.org/lod/arabspatial/resource/Child_Underweight\"> Child Underweight</a> li�s par pays et par ann�e. Visite <a href=\"http://data.ifpri.org/sparql\">d'un crit�re SPARQL pour Global Hunger Index de requ�te</a>.</p>";
      report +="        </p> \n";
      report +="   </td> \n";
      report +="</TR>\n";
      report +="</TABLE>\n";
...
//        report +="         <p align =\"right\" class=\"description\"> <a href=\"http://data.ifpri.org/lod/arabspatial/fr\">French</a>, <a href=\"http://data.ifpri.org/lod/arabspatial/fr\">Spanish</p>";
  ...
  private void writeID (String resourceName, String selectedLangauge)
    ...
    if (resourceName.length() >0)
      ...
      if (selectedLangauge.equalsIgnoreCase("EN"))
        ...
        report += "     &#160; &#160; Raw data <a href=\""+this.currentServerPath+"/lod/arabspatial/data/"+resourceName+"\" title=\""+rdf+resourceName+"\">(RDF) </a> </p> \n";
        }
      else if  (selectedLangauge.equalsIgnoreCase("ES"))
        {
        report += "     <h2>Resource: IFPRI Linked Open Data - �ndice Global del Hambre   - "+resourceName+"</h2><h3> URI: "+resourceBase+resourceName+"</h3> ";
        report += "     &#160; &#160; Los datos brutos <a href=\""+this.currentServerPath+"/lod/arabspatial/data/"+resourceName+"\" title=\""+rdf+resourceName+"\">(RDF) </a> </p> \n";
        } 
        ...
        report += "     &#160; &#160; Les donn�es brutes  <a href=\""+this.currentServerPath+"/lod/arabspatial/data/"+resourceName+"\" title=\""+rdf+resourceName+"\">(RDF) </a> </p> \n";
        } 
      else 
        {
        report += "     <h2>Resource: IFPRI Linked Open Data - Arab Spatial - "+resourceName+"</h2><h3> URI: "+resourceBase+resourceName+"</h3> ";
      ...
      if (selectedLangauge.equalsIgnoreCase("EN"))
        {
        report += "     <h2>Resource: IFPRI Linked Open Data - Global Hunger Index "+resourceName+"</h2><h3> URI: "+resourceBase+resourceName+"</h3> ";
        report += "     &#160; &#160; Raw data <a href=\"http://data.ifpri.org/lod/arabspatial.rdf"+"\" title=\""+rdf+resourceName+"\">(RDF) </a> </p> \n";
        }
      else if  (selectedLangauge.equalsIgnoreCase("ES"))
        {
        report += "     <h2>Resource: IFPRI Linked Open Data - �ndice Global del Hambre "+resourceName+"</h2><h3> URI: "+resourceBase+resourceName+"</h3> ";
        report += "     &#160; &#160; Los datos brutos  <a href=\"http://data.ifpri.org/lod/arabspatial.rdf"+"\" title=\""+rdf+resourceName+"\">(RDF) </a> </p> \n";
        } 
      else if  (selectedLangauge.equalsIgnoreCase("FR"))
        {
        report += "     <h2>Resource: IFPRI Linked Open Data - Global Hunger Index "+resourceName+"</h2><h3> URI: "+resourceBase+resourceName+"</h3> ";
        report += "     &#160; &#160; Les donn�es brutes  <a href=\"http://data.ifpri.org/lod/arabspatial.rdf"+"\" title=\""+rdf+resourceName+"\">(RDF) </a> </p> \n";
        } 
      else 
        {
        report += "     <h2>Resource: IFPRI Linked Open Data - Arab Spatial  "+resourceName+"</h2><h3> URI: "+resourceBase+resourceName+"</h3> ";
  ...
  private void writeMenu(String selectedLanguge)
    ...
    if (selectedLanguge.equalsIgnoreCase("EN"))
      {
      report += " <h2><a href=\""+this.currentServerPath+"/lod/arabspatial/resource/"+"\">Overview</a> </h2>";
	  report += " <h2><a href=\"http://www.arabspatial.org\">About</a> </h2>";
   
      report += " <h2>Categories </h2>";
      report += "   <div>  \n";
      
       // Classes  
      findClassTree("http://data.ifpri.org/lod/arabspatial/resource/Indicator",0);
...
//      report +="     <li> <a href=\"http://data.ifpri.org/lod/arabspatial.rdf\">RDF</a> </li>";
      ...
      report += " <h2><a href=\""+this.currentServerPath+"/lod/arabspatial/resource/"+"\">Visi�n de conjunto</a> </h2>";
	  report += " <h2><a href=\"http://www.ifpri.org/book-8018/node/8058\">Sobre</a> </h2>";
   
      report += " <h2>Categor�as</h2>";
      report += "   <div>  \n";
      ...
      report +="<h2>Enlaces de inter�s</h2>";
      report += " <div> \n";
      report += " <ul> \n";
      report +="     <li> <a href=\"http://data.ifpri.org/sparql\">Punto final SPARQL para �ndice Global del Hambre</a> </li>";
      ...
      report += " <h2><a href=\""+this.currentServerPath+"/lod/arabspatial/resource/"+"\">Vue d'ensemble</a> </h2>";
      ...
      report +="     <li> <a href=\"http://www.ifpri.org/book-8018/node/8059\">Global Hunger Index Report </a> </li>";
      report +="     <li> <a href=\"http://public.tableausoftware.com/shared/6XX5TPNP4\">Global Hunger Index Map </a> </li>";
      report +="     <li> <a href=\"http://unstats.un.org/unsd/methods/m49/m49alpha.htm\">Country ISO3 CODE</a> </li>";
      report +="     <li> <a href=\"http://www.ifpri.org/copyright\">IFPRI Copyright </a> </li>";
      report +="     <li> <a href=\"http://www.ifpri.org/datasets/disclaimer \">IFPRI Data Disclaimer </a> </li>";
      report += " </ul> \n";
