...
public class ConnectorToOntology
  ...
  String fileName= "http://www.agrodep.org/sites/default/files/arabspatial.owl";
  boolean isValidISO3Flag = false; // if parameter ISO3 is valid, it is true
  String ontologyBase = "http://data.ifpri.org/lod/arabspatial/resource/";
   
  String base= "http://data.ifpri.org/lod/arabspatial/resource/";
  String resourceBase= "http://data.ifpri.org/lod/arabspatial/resource/";
  String dataBase= "http://data.ifpri.org/lod/arabspatial/data/";
  String pageBase= "http://data.ifpri.org/lod/arabspatial/page/";
  String queryBase;
