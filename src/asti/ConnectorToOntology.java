...
public class ConnectorToOntology
  ...
  String fileName= "http://data.ifpri.org/lod/asti.owl";
  boolean isValidISO3Flag = false; // if parameter ISO3 is valid, it is true
  String ontologyBase = "http://data.ifpri.org/lod/asti/resource/";
   
  String base= "http://data.ifpri.org/lod/asti/resource/";
  String resourceBase= "http://data.ifpri.org/lod/asti/resource/";
  String dataBase= "http://data.ifpri.org/lod/asti/data/";
  String pageBase= "http://data.ifpri.org/lod/asti/page/";
  String queryBase;
