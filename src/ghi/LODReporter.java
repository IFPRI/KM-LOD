...
import ghi.ConnectorToOntology;
...
public class LODReporter 
  {
  String report = null;	
  String baseOntology = "http://data.ifpri.org/lod/ghi/resource/";
  String resourceBase;
  String base;
  String currentServerPath; 
  String rdf;
  Model model;
  String base_xmlns = "ghi";
  ...
  public void writeStatement(Model selectedModel, com.hp.hpl.jena.rdf.model.Statement statement)
    ...
    Property predicate = statement.getPredicate();
      ...
      String newPath = this.currentServerPath+"/lod/ghi/resource/";
    ...
    if (object.isResource() && object.toString().contains("http://"))
      ...
      if (object.toString().startsWith("http://www.fao.org"))
        {
        report +="  &#160; <span rel=\""+predicate.getURI()+"\" resource=\""+object.toString()+"\">  <a href=\""+object.toString()+"\" title = \""+object.toString()+"\">"+object.toString()+"</a> </span>\n";
        report += "</li>\n";
        }
      else
        {
  ...
  public void writeInstanceStatement( com.hp.hpl.jena.rdf.model.Statement statement,Resource selectedClass)
    ...
    if (predicate.getLocalName().equalsIgnoreCase(typeProperty.getLocalName())  && object.toString().equalsIgnoreCase(selectedClass.getURI()))
      ...
      if (subject.getURI().startsWith(this.currentServerPath))
        ...
        {
        report += "<span class='active-entity'> <span rel='owl:Individual' resource='"+this.currentServerPath+"/lod/ghi/resource/"+subject.getLocalName()+"'>"+"<a href=\""+this.currentServerPath+"/lod/ghi/resource/"+subject.getLocalName()+"\" title =\""+subject.getURI()+"\">"+subject.getLocalName()+"</a></span></span>";
        }  
      else
        report += "<span class='active-entity'> <span rel='owl:Individual' resource='"+subject.getURI()+"'>"+"<a href=\""+subject.getURI()+"\" title =\""+subject.getURI()+"\">"+subject.getLocalName()+"</a></span></span>";
...
*/
  ...
  private void writeIFPRILogo(String selectedLanguage)
    ...
    if (selectedLanguage.equalsIgnoreCase("EN"))
      ...
      report +="    <td><p class=\"name\"><h1>Linked Open Data - Global Hunger Index</h1></p>\n";
      report +="         <p align =\"right\" class=\"description\"> <a href=\"http://data.ifpri.org/lod/ghi/fr\">French</a>, <a href=\"http://data.ifpri.org/lod/ghi/fr\">Spanish</p>";
      report +="        <p class=\"newsdet\"><a href=\"http://data.ifpri.org/\" target=\"_blank\"><strong>IFPRI Data</strong></a>&gt;";
      report +="                             <a href=\"http://www.ifpri.org/book-8018/node/8058\" target=\"_blank\"><strong>Global Hunger Index Report</strong></a> <br>&nbsp; </br>";

      report +="         <p class=\"description\">The Global Hunger Index (GHI) is a tool designed to comprehensively measure and track hunger globally and by region and by country. Calculated each year by the International Food Policy and Research Institute (IFPRI) , the GHI highlights successes and failures in hunger reduction and provides insights into the drivers of hunger, and food and nutrition insecurity. The global hunger index combines three equally weighted indicators into one index: undernourishment, child underweight, and child mortality. The GHI along with the indicator scores for countries are published as Linked Open data. The GHI LOD is based on resource description framework (RDF) and linked with ISO 3166-1 alpha 3 code. You can query GHI using a SPARQL ENDPOINT. To run a query, please visit the <a href=\"http://data.ifpri.org/sparql\">SPARQL endpoint</a>.</p>";
      report +="        </p> \n";
      report +="   </td> \n";
      report +="</TR>\n";
      report +="</TABLE>\n";
      ...
      report +="<TR> \n";
      report +="    <td><a href=\"http://data.ifpri.org\" target=\"_blank\"><img alt=\"IFPRI\" src=\"http://data.ifpri.org/IFPRILogo.jpg\" border=\"0\"></img></a></td>\n";
      report +="    <td><p class=\"name\"><h1>Linked Open Data - ?dice Global del Hambre </h1></p>\n";
      report +="         <p align =\"right\" class=\"description\"> <a href=\"http://data.ifpri.org/lod/ghi/en\">English</a>, <a href=\"http://data.ifpri.org/lod/ghi/fr\">French</p>";
      report +="        <p class=\"newsdet\"><a href=\"http://data.ifpri.org/\" target=\"_blank\"><strong>IFPRI Datos</strong></a>&gt;";
      report +="                             <a href=\"http://www.ifpri.org/book-8018/node/8058\" target=\"_blank\"><strong>Informe Global Hunger Index </strong></a> <br>&nbsp; </br>";

      report +="         <p class=\"description\">Le Global Hunger Index (GHI) de données est également publié en tant que Linked Open Data (LOD) et lié à la norme ISO 3166-1 (alpha 3) du code. Le Linked Open Data de la version IGS est implémenté en utilisant le Resource Description Framework (RDF). Il utilise les indicateurs de <a href=\"http://data.ifpri.org/lod/ghi/resource/Child_Mortality\">Child Mortality</a>, <a href =\"http://data.ifpri.org/lod/ghi/resource/Undernourishment\">Undernourishment</a>,<a href=\"http://data.ifpri.org/lod/ghi/resource/Child_Underweight\"> Child Underweight</a> liés par pays et par année. Visite  <a href=\"http://data.ifpri.org/sparql\">d'un critère SPARQL pour Global Hunger Index de requête</a> para consulta. </p>";
      report +="        </p> \n";
      report +="   </td> \n";
      report +="</TR>\n";
      report +="</TABLE>\n";
      ...
      report +="    <td><a href=\"http://data.ifpri.org\" target=\"_blank\"><img alt=\"IFPRI\" src=\"http://data.ifpri.org/IFPRILogo.jpg\" border=\"0\"></img></a></td>\n";
      report +="    <td><p class=\"name\"><h1>Linked Open Data - Global Hunger Index</h1></p>\n";
      report +="         <p align =\"right\" class=\"description\"> <a href=\"http://data.ifpri.org/lod/ghi/en\">English</a>, <a href=\"http://data.ifpri.org/lod/ghi/es\">Spanish</p>";
      report +="        <p class=\"newsdet\"><a href=\"http://data.ifpri.org/\" target=\"_blank\"><strong>IFPRI donn?s </strong></a>&gt;";
      report +="                             <a href=\"http://www.ifpri.org/book-8018/node/8058\" target=\"_blank\"><strong>Rapport mondial Indice de la faim </strong></a> <br>&nbsp; </br>";

      report +="         <p class=\"description\">Le Global Hunger Index (GHI), ou Indice de la faim dans le monde, est un outil statistique calculé chaque année par l’Institut international de recherche sur les politiques alimentaires (IFPRI). Cet indice permet de mesurer et de suivre de manière détaillée l’évolution de la faim dans le monde, pays par pays et région par région.  Le GHI met en évidence les succès et les échecs des programmes de réduction de la faim et offre un éclairage sur les facteurs de la faim et de l’insécurité alimentaire et nutritionnelle. Le GHI réunit trois indicateurs, également pondérés, en un seul indice : la sous-alimentation, la sous-alimentation infantile et la mortalité infantile. Les calculs et scores du GHI par pays sont publiés en tant que données ouvertes et liées (Linked Open Data—LOD).  Les données LOD du GHI sont présentées dans le cadre de description des ressources (Resource Description Framework—RDF) et liées au code ISO 3166-1 alpha 3. Vous pouvez rechercher les données du GHI au moyen de SPARQL ENDPOINT. Pour exécuter une requête, visitez: <a href=\"http://data.ifpri.org/sparql\">SPARQL endpoint</a>.</p>";
      report +="        </p> \n";
      report +="   </td> \n";
      report +="</TR>\n";
      report +="</TABLE>\n";
      ...
      report +="         <p class=\"description\">The Global Hunger Index (GHI) data is also published as Linked Open Data (LOD) and linked with ISO 3166-1 (alpha 3) code. The Linked Open Data version of GHI is implemented using the Resource Description Framework (RDF). It uses the indicators of <a href=\"http://data.ifpri.org/lod/ghi/resource/Child_Mortality\">Child Mortality</a>, <a href =\"http://data.ifpri.org/lod/ghi/resource/Undernourishment\">Undernourishment</a>,<a href=\"http://data.ifpri.org/lod/ghi/resource/Child_Underweight\"> Child Underweight</a> linked by country and by year. Visit <a href=\"http://data.ifpri.org/sparql\">a SPARQL endpoint for Global Hunger Index</a>. </p>";
      report +="        </p> \n";
      report +="   </td> \n";
      report +="</TR>\n";
      report +="</TABLE>\n";
  ...
  private void writeID (String resourceName, String selectedLangauge)
    ...
    if (resourceName.length() >0)
      ...
      if (selectedLangauge.equalsIgnoreCase("EN"))
        {
        report += "     <h2>Resource: IFPRI Linked Open Data - Global Hunger Index  - "+resourceName+"</h2><h3> URI: "+resourceBase+resourceName+"</h3> ";
        report += "     &#160; &#160; Raw data <a href=\""+this.currentServerPath+"/lod/ghi/data/"+resourceName+"\" title=\""+rdf+resourceName+"\">(RDF) </a> </p> \n";
        }
      else if  (selectedLangauge.equalsIgnoreCase("ES"))
        {
        report += "     <h2>Resource: IFPRI Linked Open Data - Índice Global del Hambre    - "+resourceName+"</h2><h3> URI: "+resourceBase+resourceName+"</h3> ";
        report += "     &#160; &#160; Los datos brutos <a href=\""+this.currentServerPath+"/lod/ghi/data/"+resourceName+"\" title=\""+rdf+resourceName+"\">(RDF) </a> </p> \n";
        } 
      else if  (selectedLangauge.equalsIgnoreCase("FR"))
        {
        report += "     <h2>Resource: IFPRI Linked Open Data - Global Hunger Index  - "+resourceName+"</h2><h3> URI: "+resourceBase+resourceName+"</h3> ";
        report += "     &#160; &#160; Les données brutes  <a href=\""+this.currentServerPath+"/lod/ghi/data/"+resourceName+"\" title=\""+rdf+resourceName+"\">(RDF) </a> </p> \n";
        } 
      else 
        {
        report += "     <h2>Resource: IFPRI Linked Open Data - Global Hunger Index  - "+resourceName+"</h2><h3> URI: "+resourceBase+resourceName+"</h3> ";
      ...
      if (selectedLangauge.equalsIgnoreCase("EN"))
        {
        report += "     <h2>Resource: IFPRI Linked Open Data - Global Hunger Index "+resourceName+"</h2><h3> URI: "+resourceBase+resourceName+"</h3> ";
        report += "     &#160; &#160; Raw data <a href=\"http://data.ifpri.org/lod/ghi.rdf"+"\" title=\""+rdf+resourceName+"\">(RDF) </a> </p> \n";
        }
      else if  (selectedLangauge.equalsIgnoreCase("ES"))
        {
        report += "     <h2>Resource: IFPRI Linked Open Data - Índice Global del Hambre  "+resourceName+"</h2><h3> URI: "+resourceBase+resourceName+"</h3> ";
        report += "     &#160; &#160; Los datos brutos  <a href=\"http://data.ifpri.org/lod/ghi.rdf"+"\" title=\""+rdf+resourceName+"\">(RDF) </a> </p> \n";
        } 
      else if  (selectedLangauge.equalsIgnoreCase("FR"))
        {
        report += "     <h2>Resource: IFPRI Linked Open Data - Global Hunger Index "+resourceName+"</h2><h3> URI: "+resourceBase+resourceName+"</h3> ";
        report += "     &#160; &#160; Les données brutes   <a href=\"http://data.ifpri.org/lod/ghi.rdf"+"\" title=\""+rdf+resourceName+"\">(RDF) </a> </p> \n";
        } 
      else 
        {
        report += "     <h2>Resource: IFPRI Linked Open Data - Global Hunger Index "+resourceName+"</h2><h3> URI: "+resourceBase+resourceName+"</h3> ";
  ...
  private void writeMenu(String selectedLanguge)
    ...
    if (selectedLanguge.equalsIgnoreCase("EN"))
      {
      report += " <h2><a href=\""+this.currentServerPath+"/lod/ghi/resource/"+"\">Overview</a> </h2>";
	  report += " <h2><a href=\"http://www.ifpri.org/book-8018/node/8058\">About</a> </h2>";
      ...
      report += " <div> \n";
      report += " <ul> \n";
      report +="     <li> <a href=\"http://www.ifpri.org/sites/default/files/ghi2013datam.xlsx\">EXCEL</a> </li>";
      report +="     <li> <a href=\"http://data.ifpri.org/lod/ghi.rdf\">RDF</a> </li>";
      report += " </ul> \n";
      report += " </div> \n";
      ...
      report += " <div> \n";
      report += " <ul> \n";
      report +="     <li> <a href=\"http://data.ifpri.org/sparql\">SPARQL endpoint for Global Hunger Index</a> </li>";
      report +="     <li> <a href=\"http://ebrary.ifpri.org/cdm/ref/collection/p15738coll2/id/127844\">Global Hunger Index Report </a> </li>";
      report +="     <li> <a href=\"http://goo.gl/60FPVO\">Global Hunger Index Map </a> </li>";
      ...
      report += " <h2><a href=\""+this.currentServerPath+"/lod/ghi/resource/"+"\">Visión de conjunto </a> </h2>";
	  report += " <h2><a href=\"http://www.ifpri.org/book-8018/node/8058\">Sobre</a> </h2>";
   
      report += " <h2>Categorías</h2>";
      report += "   <div>  \n";
      ...
      report += " <div> \n";
      report += " <ul> \n";
      report +="     <li> <a href=\"http://data.ifpri.org/sparql\">Punto final SPARQL para Índice Global del Hambre </a> </li>";
      report +="     <li> <a href=\"http://ebrary.ifpri.org/cdm/ref/collection/p15738coll2/id/127844\">Índice Global del Hambre Informe  </a> </li>";
      report +="     <li> <a href=\"http://goo.gl/60FPVO\">Mapa Índice Global del Hambre </a> </li>";
      report +="     <li> <a href=\"http://unstats.un.org/unsd/methods/m49/m49alpha.htm\">País ISO3 CÓDIGO </a> </li>";
      ...
      report += " <h2><a href=\""+this.currentServerPath+"/lod/ghi/resource/"+"\">Vue d'ensemble </a> </h2>";
	  report += " <h2><a href=\"http://www.ifpri.org/book-8018/node/8058\">Sur</a> </h2>";
   
      report += " <h2>Catégories</h2>";
      report += "   <div>  \n";
      ...
      report += " <div> \n";
      report += " <ul> \n";
      report +="     <li> <a href=\"http://data.ifpri.org/sparql\">SPARQL Critère pour Global Hunger Index</a> </li>";
      report +="     <li> <a href=\"http://ebrary.ifpri.org/cdm/ref/collection/p15738coll2/id/127844\">Rapport mondial Indice de la faim </a> </li>";
      report +="     <li> <a href=\"http://goo.gl/60FPVO\">Carte du Monde indice de la faim </a> </li>";
      ...
      report +="     <li> <a href=\"http://www.ifpri.org/datasets/disclaimer \">IFPRI données Responsabilité </a> </li>";
      report += " </ul> \n";
      report += " </div> \n";
  ...
  public void writeAllResources(Model selectedModel)
    ...
    for (int i=0;i< allClassesVector.size();i++)
      ...
      System.out.println("writeAllResources selectedClass:"+selectedClass);
