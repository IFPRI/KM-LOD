...
//  String fileName = "http://www.agrodep.org/sites/default/files/ghi.rdf"; // test
  String fileName= "http://data.ifpri.org/lod/ghi.rdf";
 // String fileName= "input/ghi.rdf";
  
  boolean isValidISO3Flag = false; // if parameter ISO3 is valid, it is true
  String ontologyBase = "http://data.ifpri.org/lod/ghi/resource/";
   
  String base= "http://data.ifpri.org/lod/ghi/resource/";
  String resourceBase= "http://data.ifpri.org/lod/ghi/resource/";
  String dataBase= "http://data.ifpri.org/lod/ghi/data/";
  String pageBase= "http://data.ifpri.org/lod/ghi/page/";
  String queryBase;
...
//    rewritePropertyWithSameAs("codeAGROVOC", "http://aims.fao.org/aos/agrovoc/c_");
  ...
  public Model getOverviewRDF()
    ...
    Model resultSetModel = executeQuery(queryString);
    System.out.println("resultSetModel"+resultSetModel);    
    return resultSetModel;
    }
  ...
  public List getInstances(String resourceName)
    ...
    System.out.println(resourceBase+resourceName);
