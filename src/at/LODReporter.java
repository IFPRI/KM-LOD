...
public class LODReporter 
  {
  String report = null;	
  String baseOntology = "http://data.ifpri.org/lod/at/resource/";
  String resourceBase;
  String base;
  String currentServerPath; 
  String rdf;
  Model model;
  String base_xmlns = "at";
 ...
 */ 
  public LODReporter(at.ConnectorToOntology connector2) 
    {
    this.connector = (at.ConnectorToOntology) connector2;
    this.model = connector.getOntologyInRDF();
	base =connector.getBase();
	resourceBase = connector.getBase();
	rdf= connector.getBase()+"data/";
...
public String getOntologyOverview(Model selectedModel,String resourceName, String currentServerPath,String language)
  ...
  public void writeStatement(Model selectedModel, com.hp.hpl.jena.rdf.model.Statement statement)
    ...
    Property predicate = statement.getPredicate();
      ...
      String newPath = this.currentServerPath+"/lod/at/resource/";
  ...
  public void writeInstanceStatement( com.hp.hpl.jena.rdf.model.Statement statement,Resource selectedClass)
    ...
    if (predicate.getLocalName().equalsIgnoreCase(typeProperty.getLocalName())  && object.toString().equalsIgnoreCase(selectedClass.getURI()))
      ...
      if (subject.getURI().startsWith(this.currentServerPath))
        ...
        {
        report += "<span class='active-entity'> <span rel='owl:Individual' resource='"+this.currentServerPath+"/lod/at/resource/"+subject.getLocalName()+"'>"+"<a href=\""+this.currentServerPath+"/lod/at/resource/"+subject.getLocalName()+"\" title =\""+subject.getURI()+"\">"+subject.getLocalName()+"</a></span></span>";
        }  
      else
        report += "<span class='active-entity'> <span rel='owl:Individual' resource='"+subject.getURI()+"'>"+"<a href=\""+subject.getURI()+"\" title =\""+subject.getURI()+"\">"+subject.getLocalName()+"</a></span></span>";
...
*/
  ...
  private void writeIFPRILogo(String selectedLanguage)
    ...
    if (selectedLanguage.equalsIgnoreCase("EN"))
      ...
      report +="    <td><p class=\"name\"><h1>Linked Open Data - Agricultural Technology Ontology (AT ontology)</h1></p>\n";
//      report +="         <p align =\"right\" class=\"description\"> <a href=\"http://data.ifpri.org/lod/arabspatial/fr\">French</a>, <a href=\"http://data.ifpri.org/lod/arabspatial/fr\">Spanish</p>";
      ...
      report +="                             <a href=\"http://www.harvestchoice.org/\"><strong>Agricultural Technology Ontology (AT ontology)</strong></a> <br>&nbsp; </br>";

      report +="         <p class=\"description\">The Agricultural Technology ontology, led by HarvestChoice at the International Food Policy Research Institute (IFPRI)</p>";
      report +="        </p> \n";
      report +="   </td> \n";
      report +="</TR>\n";
      report +="</TABLE>\n";
...
//      report +="         <p align =\"right\" class=\"description\"> <a href=\"http://data.ifpri.org/lod/arabspatial/fr\">French</a>, <a href=\"http://data.ifpri.org/lod/arabspatial/fr\">Spanish</p>";
      report +="        <p class=\"newsdet\"><a href=\"http://data.ifpri.org/\" target=\"_blank\"><strong>IFPRI Data</strong></a>&gt;";
      report +="                             <a href=\"http://www.at.cgiar.org/\"><strong>Agricultural Technology Ontology (AT ontology)</strong></a> <br>&nbsp; </br>";
  ...
  private void writeID (String resourceName, String selectedLangauge)
    ...
    if (resourceName.length() >0)
      ...
      if (selectedLangauge.equalsIgnoreCase("EN"))
        {
        report += "     <h2>Resource: IFPRI Linked Open Data - AT ontology  - "+resourceName+"</h2><h3> URI: "+resourceBase+resourceName+"</h3> ";
        report += "     &#160; &#160; Raw data <a href=\""+this.currentServerPath+"/lod/at/data/"+resourceName+"\" title=\""+rdf+resourceName+"\">(RDF) </a> </p> \n";
        }
      else if  (selectedLangauge.equalsIgnoreCase("ES"))
        {
        report += "     <h2>Resource: IFPRI Linked Open Data - AT ontology  - "+resourceName+"</h2><h3> URI: "+resourceBase+resourceName+"</h3> ";
        report += "     &#160; &#160; Los datos brutos <a href=\""+this.currentServerPath+"/lod/at/data/"+resourceName+"\" title=\""+rdf+resourceName+"\">(RDF) </a> </p> \n";
        } 
      else if  (selectedLangauge.equalsIgnoreCase("FR"))
        {
        report += "     <h2>Resource: IFPRI Linked Open Data - AT ontology  - "+resourceName+"</h2><h3> URI: "+resourceBase+resourceName+"</h3> ";
        report += "     &#160; &#160; Les donn�es brutes  <a href=\""+this.currentServerPath+"/lod/at/data/"+resourceName+"\" title=\""+rdf+resourceName+"\">(RDF) </a> </p> \n";
        } 
      else 
        {
        report += "     <h2>Resource: IFPRI Linked Open Data - AT ontology - "+resourceName+"</h2><h3> URI: "+resourceBase+resourceName+"</h3> ";
      ...
      if (selectedLangauge.equalsIgnoreCase("EN"))
        {
        report += "     <h2>Resource: IFPRI Linked Open Data - AT ontology "+resourceName+"</h2><h3> URI: "+resourceBase+resourceName+"</h3> ";
        report += "     &#160; &#160; Raw data <a href=\"http://data.ifpri.org/lod/at.owl"+"\" title=\""+rdf+resourceName+"\">(RDF) </a> </p> \n";
        }
      else if  (selectedLangauge.equalsIgnoreCase("ES"))
        {
        report += "     <h2>Resource: IFPRI Linked Open Data - AT ontology"+resourceName+"</h2><h3> URI: "+resourceBase+resourceName+"</h3> ";
        report += "     &#160; &#160; Los datos brutos  <a href=\"http://data.ifpri.org/lod/at.owl"+"\"  title=\""+rdf+resourceName+"\">(RDF) </a> </p> \n";
        } 
      else if  (selectedLangauge.equalsIgnoreCase("FR"))
        {
        report += "     <h2>Resource: IFPRI Linked Open Data - AT ontology "+resourceName+"</h2><h3> URI: "+resourceBase+resourceName+"</h3> ";
        report += "     &#160; &#160; Les donn�es brutes  href=\"http://data.ifpri.org/lod/at.owl"+"\"  title=\""+rdf+resourceName+"\">(RDF) </a> </p> \n";
        } 
      else 
        {
        report += "     <h2>Resource: IFPRI Linked Open Data - Arab Spatial  "+resourceName+"</h2><h3> URI: "+resourceBase+resourceName+"</h3> ";
        report += "     &#160; &#160; Raw data <a href=\"http://data.ifpri.org/lod/at.owl"+"\" >(RDF) </a> </p> \n";
        } 
      }
    } 
  ...
  private void writeMenu(String selectedLanguge)
    ...
    if (selectedLanguge.equalsIgnoreCase("EN"))
      {
      report += " <h2><a href=\""+this.currentServerPath+"/lod/at/resource/"+"\">Overview</a> </h2>";
	  report += " <h2><a href=\"http://www.ifpri.org/book-39/ourwork/programs/priorities-public-investment/AT ontology-database\">About</a> </h2>";
   
      report += " <h2>Categories </h2>";
      report += "   <div>  \n";
      
       // Classes  
      findClassTree("http://data.ifpri.org/lod/at/resource/Technology",0);
      ...
      report +="     <li> <a href=\"http://data.ifpri.org/lod/at.owl\">OWL</a> </li>";
      report += " </ul> \n";
      report += " </div> \n";
      ...
      report += " <h2><a href=\""+this.currentServerPath+"/lod/at/resource/"+"\">visión de conjunto</a> </h2>";
	  report += " <h2><a href=\"http://www.ifpri.org/book-39/ourwork/programs/priorities-public-investment/AT ontology-database\">Sobre</a> </h2>";
 ...
 //     report +="     <li> <a href=\"http://data.ifpri.org/lod/arabspatial.owl\">OWL</a> </li>";
      ...
      report += " <h2><a href=\""+this.currentServerPath+"/lod/at/resource/"+"\">Vue d'ensemble</a> </h2>";
